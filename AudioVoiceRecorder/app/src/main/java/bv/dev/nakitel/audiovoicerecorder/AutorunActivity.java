...
public class AutorunActivity extends AppCompatActivity {
    ...
    private final MediaBrowserCompat.ConnectionCallback connCallbacks =
            new MediaBrowserCompat.ConnectionCallback() {
                ...
                public void onConnected() {
                    ...
                    try {
                        MediaControllerCompat mediaCntrlr = new MediaControllerCompat(AutorunActivity.this, sesTok);
                        MediaControllerCompat.setMediaController(AutorunActivity.this, mediaCntrlr);
    ...
    private final View.OnClickListener ibStopOCL = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            MediaControllerCompat mediaCntrlr = MediaControllerCompat.getMediaController(AutorunActivity.this);
            if(mediaCntrlr == null) {
                return;
            }
