...
public class AudioService extends MediaBrowserServiceCompat {
    ...
    private static final int VISUALIZER_CAPTURE_SIZE = 1024; // default is max 1024, min 128 (2^n)
    //private static final int VISUALIZER_SAMPLE_RATE = 4000; old
    private static final int VISUALIZER_SAMPLE_RATE = 15000;
    private static final int AMPLITUDE_CHK_RATE = 1000;
    ...
    public void onDestroy() {
        ...
        Intent newIntent = new Intent(getApplicationContext(), AudioService.class);
        PendingIntent pendingIntent = PendingIntent.getService(getApplicationContext(), 0, newIntent, 0);
    }
    ...
    public void onTaskRemoved(Intent rootIntent) {
        ...
        Intent intent = new Intent(getApplicationContext(), AutorunActivity.class);
